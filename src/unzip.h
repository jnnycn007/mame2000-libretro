...
/* Read compressed data from a zip entry
   in:
     ...
     ent entry to read
   out:
     data buffer for data, ent.compressed_size uint8_t's allocated by the caller
   return:
     ==0 success
     <0 error
*/
...
/* Read decompressed data from a zip entry
   in:
     ...
     ent entry to read
   out:
     data buffer for data, ent.uncompressed_size uint8_t's allocated by the caller
   return:
     ==0 success
     <0 error
*/
